...
*
*   Code description:
*   This Code realizes the multiplication of two vectors, element by element,
*   and stores the result in another vector using parallelization.
...
*   and ploted in one graph ("Product of Vectors (element by element).png") for comparison.
*/
...
void prod(double* a, double* b, double*c, int size, int n_per_thread)
{
	int i;
