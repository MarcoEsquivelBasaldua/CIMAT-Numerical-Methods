...
- "Lagrange Interpolation.png" this image file contents the grpah of the chosen function, the graph of interpolating polinomyal and the interpolation points

Compiler instructions:
- By positioning in the folder where "Lagrange.c" and "Enter points.txt" are stored, use the Makefile placed in this folder, just write "make" and press enter in the terminal

- Results:
    Interpolation polinomyal using Lagrange method given points in "Enter points.txt"
