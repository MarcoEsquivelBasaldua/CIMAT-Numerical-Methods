...
- If A is a square Matrix and b has sufficient values as solutions for the linear system:
     ...
     calculates the values of x from the equation Ax = b using Gauss elimination with pivots
...
- By positioning in the folder where Solver_GaussPivot.c, M_SMALL.txt and V_SMALL.txt are stored, use gcc compiler: 
    gcc Solver_GaussPivot.c
- Run: 
