...
- If A is a square Matrix and b has sufficient values as solutions for the linear system:
     ...
     calculates the values of x from the equation Ax = b using Gauss elimination
     (NOTE: this method does not use any kind of pivot)
...
- By positioning in the folder where Solver_Gauss.c, M_SMALL.txt and V_SMALL.txt are stored, use gcc compiler: 
    gcc Solver_Gauss.c
- Run: 
