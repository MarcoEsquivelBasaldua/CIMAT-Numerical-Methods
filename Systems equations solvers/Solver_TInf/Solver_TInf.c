...
void solver_TInf(double**,double**,int,int,int,int);    // Function to solve x given a square upper triangular matrix
...
void solver_TInf(double** A, double** b, int n, int m, int k, int l){
/*
*   Inputs:
