...
void linear_reg(int,double*,double*);       // Least squares function
...
void linear_reg(int n, double *x, double *y){
/*
*   Inputs:
...
*/
    ...
    // a and b are computed from the function g(x) = a + bx
    double b = (sum_xy - sum_x * sum_y / n)/(sum_x2 -sum_x * sum_x /n);
    double a = sum_y/n - (b/n) * sum_x;

    printf("The fitting line is: g(x) = %lf + %lfx\n",a,b);
