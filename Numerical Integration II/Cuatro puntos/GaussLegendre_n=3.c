...
*       by Gauss-Legendre method for the given interval using 4 points (n=3).
...
*/
    ...
    // x_i points
    double x_i[N] = {-sqrt((3.0+2.0*sqrt(6.0/5.0))/7.0), -sqrt((3.0-2.0*sqrt(6.0/5.0))/7.0), sqrt((3.0-2.0*sqrt(6.0/5.0))/7.0), sqrt((3.0+2.0*sqrt(6.0/5.0))/7.0)};

    // Weights w_i
    double w_i[N] = {(18.0-sqrt(30.0))/36.0, (18.0+sqrt(30.0))/36.0, (18.0+sqrt(30.0))/36.0, (18.0-sqrt(30.0))/36.0};
