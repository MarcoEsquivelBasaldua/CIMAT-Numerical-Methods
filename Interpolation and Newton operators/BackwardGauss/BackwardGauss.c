...
*       Gauss Backward central differences method.
...
void BackwarGauss(double,double,int,int); // Interpolation by Gauss Backward central differences method
...
void BackwarGauss(double x_0, double x_n, int n, int f_selec){
/*
*   Inputs:
...
*/
    ...
    // Gauss Backward Method in action
