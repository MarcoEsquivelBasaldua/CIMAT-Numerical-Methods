...
- "Gauss Backward Central Interpolation.png" this image file contents the grpah of the chosen function, the graph of interpolating polinomyal and the interpolation        
    points

Compiler instructions:
- By positioning in the folder where "BackwardGauss.c" and "Enter points.txt" are stored, use the Makefile placed in this folder, just write "make" and press enter in the terminal
